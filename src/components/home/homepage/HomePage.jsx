    ...
    >
      <Typography
        ...
        sx={{
          ...
          lineHeight: 1.2,
          mb: 3,
          fontSize: { lg: "3.125rem", md: "2.8125rem", xs: "2.1875rem" },
          color: DESIGN_CONSTANTS.colors.white,
      ...
      >
        A comprehensive educational system that connects students and teachers
        in an advanced interactive environment for an exceptional learning
        experience.
      </Typography>
